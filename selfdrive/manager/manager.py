...
def manager_init() -> None:
  ...
  default_params: List[Tuple[str, Union[str, bytes]]] = [
    ...
    ("EonClusterHudNaverLandscape", "1"),
    ("EonClusterHudNaverMapFit", "1"),
    ("EonClusterHudNaverMapScale", "100"),
    ("EonClusterHudNaverMapQuality", "90"),
    ...
    ("StopDistance", "600"),
    ("TFollowDecelBoost", "30"),
    ("RadarReactionFactor", "70"),
    ("LongTuningKpV", "100"),
    ("LongTuningKiV", "200"),
    ("LongTuningKf", "100"),
