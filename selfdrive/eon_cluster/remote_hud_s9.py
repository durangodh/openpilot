...
def _packet(sm, *args, **kwargs):
  ...
  packet["hudNaverLandscape"] = _bounded_int("EonClusterHudNaverLandscape", 1, 0, 1)
  packet["hudNaverMapFit"] = _bounded_int("EonClusterHudNaverMapFit", 1, 0, 1)
  packet["hudNaverMapScale"] = _bounded_int("EonClusterHudNaverMapScale", 100, 50, 100)
  packet["hudNaverMapQuality"] = _bounded_int("EonClusterHudNaverMapQuality", 90, 60, 95)
