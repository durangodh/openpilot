...
SOURCES = {
  'android/app/Activity.java': 'package android.app; public class Activity extends android.content.Context { public android.view.Window w=new android.view.Window(); public android.view.Window getWindow(){return w;} }\n',
  ...
  'com/naver/map/carrot/CarrotNaverBridge.java': 'package com.naver.map.carrot; class CarrotNaverBridge { private static volatile Object activity; static void setActivity(Object a){activity=a;} public int sent; public android.graphics.Bitmap last; void sendBitmap(Object b){sent++;last=(android.graphics.Bitmap)b;} }\n',
