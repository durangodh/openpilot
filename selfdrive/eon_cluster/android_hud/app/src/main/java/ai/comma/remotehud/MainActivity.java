...
public final class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        View subtitle = text("v0.43  ·  우측 정보·RPM 글자 행 겹침 보정 UI / 1CBE:0092",
        ...
        TextView displayGuide = text(
                "8인치 또는 9.2인치를 선택하면 주행 화면 비율은 유지하고 우측 정보 패널을 실제 폭의 15%로 맞춥니다. RPM 아크는 유지하고 RPM 글자와 회전수 숫자만 위로 이동해 기어·도착시간·주행모드 행과 겹치지 않으며, nMirror 즐겨찾기 바로 옆부터 표시됩니다.",
